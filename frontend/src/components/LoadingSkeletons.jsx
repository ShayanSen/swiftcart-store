/** shared loading placeholders and code generated by ai coming from daisy ui docs */
...
export function OrderChatPanelSkeleton() {
  return (
    <div className="space-y-4">
      ...
      <div className="flex h-140 flex-col overflow-hidden rounded-box border border-base-300 bg-base-100">
